...
from snowdragon.ml.run_models import (
    evaluate_all_models,
    train_and_store_models,
    validate_all_models,
)
from snowdragon.process.process import preprocess_all_profiles, preprocess_dataset
...
class Snowdragon:
    ...
    def validate(self, valid_config: str):
        ...
        all_scores = pd.DataFrame(all_scores).rename(
            columns={
