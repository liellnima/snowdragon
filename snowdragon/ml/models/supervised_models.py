...
def knn(
    x_train, y_train, cv, n_neighbors=20, weights="distance", name="KNearestNeighbours", only_model=False, **kwargs
):
    """
    Support Vector Machine with Radial Basis functions as kernel.
...
def ada_boost(
    ...
    **kwargs,
    ...
    Returns:
        dict: contains results of models
    """
    eec = EasyEnsembleClassifier(n_estimators=n_estimators, sampling_strategy=sampling_strategy, random_state=42)
    if only_model:
        return eec
