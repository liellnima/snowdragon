...
def visualize_original_data(smp):
    ...
    smp_profile_name ="S31H0368" #"S31H060"
    ...
    for label_num, distance in zip(smp_profile["label"], smp_profile["distance"]):
        if (label_num != last_label_num):
            ...
            ax.axvspan(last_distance, distance-1, color=COLORS[last_label_num], alpha=0.5)
        ...
        if ANTI_LABELS[label_num] not in handles:
            handles.append(ANTI_LABELS[label_num])
