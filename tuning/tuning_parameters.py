...
LABEL_SPREADING_PARAMS={"kernel": "knn", "alpha": 0.1}
...
RF_BAL_PARAMS={"n_estimators": 500, "criterion": "entropy", "max_features": "sqrt",
               "max_samples": 0.8, "resample": True}
# not important: max_features (max_samples is important!!!)
RF_PARAMS={"n_estimators": 500, "criterion": "entropy", "max_features": "sqrt",
...
KNN_PARAMS={"n_neighbors": 4} # weights should be always distance
...
EASY_ENSEMBLE_PARAMS={"n_estimators": 1000, "sampling_strategy": "all"}
...
BLSTM_PARAMS={"batch_size": 8, "epochs": 100, "learning_rate": 0.01,
              "rnn_size": 50, "dense_units": 0, "dropout": 0.2}
...
ENC_DEC_PARAMS={"batch_size": 8, "epochs": 100, "learning_rate": 0.001,
                "rnn_size": 150, "dense_units": 100, "dropout": 0.2,
