...
RF_PARAMS={"n_estimators": 1000, "criterion": "entropy", "max_features": "sqrt",
...
KNN_PARAMS={"n_neighbors": 10} # weights should be always distance
...
# rnn size=[50, 100, 150]
# batch_size=[32, 8], epochs=[100], learning_rate=[0.01, 0.001], dropout=[0, 0.2, 0.5], dense_units=[0, 100]
# TODO: maybe run BLSTM also with rnn_size 150 and dropout 0.5 once?
BLSTM_PARAMS={"batch_size": 32, "epochs": 100, "learning_rate": 0.01,
              "rnn_size": 50, "dense_units": 100, "dropout": 0.2}
...
ENC_DEC_PARAMS={"batch_size": 32, "epochs": 15, "learning_rate": 0.001,
                "rnn_size": 100, "dense_best_units": 0, "dropout": 0.2,
